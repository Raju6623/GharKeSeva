...
const HouseMaidServicePage = () => {
  ...
  useEffect(() => {
    dispatch(fetchServices(bookingType));
            ...
            <div className="flex bg-gray-100 p-1.5 rounded-2xl w-fit shadow-inner border border-gray-200">
              {['One-Time', 'Subscription'].map((type) => (
                <button
                  ...
                  className={`px-8 py-3 rounded-xl text-sm font-bold transition-all duration-300 ${bookingType === type
                        ...
                        <div className="flex items-center justify-between md:flex-col md:items-end gap-2 w-full md:w-auto">
                          ...
                          {isInCart ? (
                            ...
                            <button
                              ...
                              className={`px-10 py-3.5 rounded-xl font-bold text-sm transition shadow-lg active:scale-95 shadow-blue-100 ${pkg.isServiceActive
