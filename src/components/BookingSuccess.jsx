        ...
        <div className="min-h-screen bg-white flex flex-col items-center justify-center p-4">
            ...
            <div className="bg-gray-50 rounded-2xl p-6 w-full max-w-md border border-gray-100 mb-8">
                ...
                <ul className="space-y-4 text-sm font-bold text-slate-700">
                    ...
                    <li className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-full bg-purple-100 text-purple-600 flex items-center justify-center font-black">2</div>
            ...
            <div className="flex flex-col w-full max-w-xs gap-3">
                <Link
                    to="/my-bookings"
                    className="w-full bg-[#6e42e5] text-white py-4 rounded-2xl font-black text-sm text-center shadow-xl shadow-purple-200 hover:bg-[#5b36bf] transition"
                >
                    Track Booking
                </Link>
                <Link
