...
const ContactPage = () => {
  ...
  const handleFormSubmission = (event) => {
    ...
    setTimeout(() => {
      ...
      alert("Thank you! Your message has been received by our Patna team.");
      setIsSubmitting(false);
      setFormState({ userName: '', userEmail: '', userPhone: '', serviceType: 'General Inquiry', userMessage: '' });
    }, 1500);
  };

  // --- 3. SUB-RENDER FUNCTIONS ---
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
      {contactMethods.map((method) => (
        ...
        >
          ...
          <p className="font-bold text-blue-600 mb-2">{method.value}</p>
    ...
    <main className="min-h-screen bg-[#FAFAFA] font-sans pb-20">
      ...
      <section className="bg-slate-900 pt-24 pb-40 text-white relative overflow-hidden text-center">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <span className="inline-flex items-center gap-2 bg-blue-600/20 text-blue-400 px-4 py-2 rounded-full text-xs font-black uppercase tracking-widest mb-6 border border-blue-500/20">
          ...
          <h1 className="text-5xl md:text-7xl font-black tracking-tighter uppercase leading-none mb-6">
            Get in <span className="text-blue-500 italic font-serif normal-case font-light">Touch.</span>
          </h1>
          ...
          <div className="lg:col-span-3 bg-white rounded-[3.5rem] shadow-2xl p-8 md:p-12 border border-slate-50">
            ...
            <form onSubmit={handleFormSubmission} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    className="w-full bg-slate-50 border-2 border-slate-100 rounded-2xl py-4 px-6 text-sm font-bold outline-none focus:border-blue-600 focus:bg-white transition-all"
                  />
                </div>
                <div className="space-y-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <select 
                    ...
                    className="w-full bg-slate-50 border-2 border-slate-100 rounded-2xl py-4 px-6 text-sm font-bold outline-none focus:border-blue-600 focus:bg-white transition-all appearance-none"
                  >
              ...
              <button 
                ...
                className="w-full bg-slate-900 text-white py-5 rounded-[2rem] font-black text-xs uppercase tracking-[0.4em] hover:bg-blue-600 transition-all flex items-center justify-center gap-3 shadow-xl active:scale-95 disabled:opacity-70"
              >
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="bg-slate-900 text-white p-10 rounded-[3.5rem] shadow-xl">
              <h3 className="text-xl font-black uppercase tracking-tight mb-8 flex items-center gap-3">
                <ShieldCheck className="text-blue-500" /> Bihar's Promise
              </h3>
            ...
            <div className="p-8 bg-blue-50 rounded-[2.5rem] border border-blue-100">
               <p className="text-[10px] font-black text-blue-600 uppercase tracking-widest mb-2">Transparency Note</p>
