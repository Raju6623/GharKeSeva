...
import { Search, MapPin, User, ChevronDown, ShoppingBag, Menu, Loader2, Globe, X, Scissors, Wind, Droplets, Zap, Wrench, Paintbrush, Home, Star, Calendar, MessageSquare, Wallet, Megaphone, Briefcase, BookOpen, ChevronRight, LogOut, Phone, Share2, Info, ShieldCheck, FileText, Bell, ClipboardList, Mic, Coins } from 'lucide-react';
    ...
    >
      ...
      <div className="p-2 space-y-1">
        <div className="grid grid-cols-2 gap-2 p-2">
          ...
          >
            <Coins size={20} className="text-amber-500 mb-2 group-hover:scale-110 transition-transform" />
